 ...
 *  Last Modified: Time-stamp: <2014-06-02 10:25:58 mike_georgiou>
 *
 *
...

{
  ...
  coefficients[0] =-(dt/Reynolds*implicit_scheme
  		     *(1./(dy_local[0]*dy_local[1]))
  		     *(viscosity[0]) );

  coefficients[1] = +( dt/Reynolds*implicit_scheme*
  		       (viscosity[1]*dy_local[0] 
  			+viscosity[0]*dy_local[2])
  		       /(dy_local[0]*dy_local[1]*dy_local[2]) );
  

  coefficients[2] = -( dt/Reynolds*implicit_scheme*
